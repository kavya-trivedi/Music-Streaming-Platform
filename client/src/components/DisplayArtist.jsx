...
const DisplayArtist = () => {
  ...
  const { playTrackById, fetchArtistById, fetchTrackById, currentTrack } = useContext(MusicPlayer);
  ...
  return (
    <>
      ...
      <div className='mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
        <img className='w-48 rounded' src={artistImage || assets.default_album} alt={artistName} />
...
export default React.memo(DisplayArtist);
